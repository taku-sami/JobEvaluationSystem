        ...
        <div class="container">
            <div class="m-2">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-2 border py-3">目標入力完了<br><div class="mt-1" style="color: #4476C6">{{$num2}}</div></div>
                    <div class="col-2 border py-3">自己申告入力中<br><div class="mt-1" style="color: #4476C6">{{$num4}}</div></div>
                    <div class="col-2 border py-3">上長評価入力中<br><div class="mt-1" style="color: #4476C6">{{$num5 + $num6}}</div></div>
                    <div class="col-2 border py-3">評価完了<br><div class="mt-1" style="color: #4476C6">{{$num7}}</div></div>
                    <div class="col-2 border py-3">最終確定済み<br><div class="mt-1" style="color: #4476C6">{{$num7}}</div></div>
                </div>
            </div>
            <div class="m-2">
                <div class="row">
            ...
            @foreach($columns as $column)
                <li class="table-row">
                    ...
                    @elseif($column->progress == 5)
                        <div class="col col-1.5">
                            <button class="btn btn-none p-0" type="button" >
                                <a href="{{ action('EvaluationController@eva_boss1', $column->id)}}" class="">
                    ...
                    @else
                        <div class="col col-1.5">
                            <button class="btn btn-none p-0" type="button" >
                                <a href="{{ action('EvaluationController@check_for_boss1', $column->id)}}" class="">
                                    <i class="fas fa-scroll fa-1x"></i>
                                </a>
                            </button>
                        </div>
