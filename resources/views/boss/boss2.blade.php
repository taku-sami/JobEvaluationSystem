                    ...
                    @foreach($columns as $column)
                        @if($column->progress == null)
                            <tr class="row100 body">
                                ...
                                @elseif($column->progress == 2)
                                    <td class="cell100 boss_column2">１次承認待ち</td>
                                @elseif($column->progress == 3)
                                    <td class="cell100 boss_column2 text-warning">２次承認待ち</td>
                                @elseif($column->progress == 4)
                                    <td class="cell100 boss_column2">評価未登録</td>
                                @elseif($column->progress == 5)
                                    <td class="cell100 boss_column2">１次評価待ち</td>
                                @elseif($column->progress == 6)
                                    <td class="cell100 boss_column2 text-warning">２次評価待ち</td>
