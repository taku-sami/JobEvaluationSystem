                    ...
                    @foreach($columns as $column)
                        @if($column->progress == null)
                            <tr class="row100 body">
                                ...
                                @elseif($column->progress == 2)
                                    <td class="cell100 boss_column2"><span class=" badge-info p-1">１次承認待ち</span></td>
                                @elseif($column->progress == 3)
                                    <td class="cell100 boss_column2 text-warning"><span class=" badge-warning p-1 text-white">２次承認待ち</span></td>
                                @elseif($column->progress == 4)
                                    <td class="cell100 boss_column2"><span class=" badge-info p-1">評価未登録</span></td>
                                @elseif($column->progress == 5)
                                    <td class="cell100 boss_column2"><span class=" badge-info p-1 text-white">１次評価待ち</span></td>
                                @elseif($column->progress == 6)
                                    <td class="cell100 boss_column2 text-warning"><span class=" badge-warning p-1 text-white">２次評価待ち</span></td>
                                @elseif($column->progress == 7)
                                    <td class="cell100 boss_column2 text-info"><span class=" badge-secondary p-1">評価終了</span></td>
                                @endif
                                @if($column->progress == null || $column->progress < 2)
                                    <td class="cell100 boss_column2"><span class=" badge-secondary p-1">未登録</span></td>
                                @elseif($column->progress == 6)
                                    <td class="cell100 boss_column2">
                                        <a href="{{ action('EvaluationController@eva_boss2', $column->id)}}">
                                            <i class="fas fa-external-link-alt fa-lg"></i>
                                        </a>
                                    </td>
                                @else
                                    <td class="cell100 boss_column2">
                                        <a href="{{ action('EvaluationController@check_for_boss2', $column->id)}}">
                                            <i class="fas fa-external-link-alt fa-lg"></i>
                                        </a>
                                    </td>
                                @endif
