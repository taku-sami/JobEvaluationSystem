            ...
            @foreach($columns as $column)
                <li class="table-row">
                    ...
                    @elseif($column->progress == 6)
                        <div class="col col-1.5">
                            <button class="btn btn-none p-0" type="button" >
                                <a href="{{ action('EvaluationController@eva_boss2', $column->id)}}" class="hover1" style="text-decoration: none;">
                    ...
                    @else
                        <div class="col col-1.5">
                            <button class="btn btn-none p-0" type="button" >
                                <a href="{{ action('EvaluationController@check_for_boss2', $column->id)}}" class="hover1" style="text-decoration: none;">
                                    <i class="fas fa-scroll fa-1x"></i>
                                </a>
                            </button>
                        </div>
