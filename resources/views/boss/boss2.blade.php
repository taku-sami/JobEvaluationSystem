        ...
        <div class="container">
            <div class="m-2">
                ...
                <div class="row text-center">
                    <div class="col-2 border py-3">目標入力中<br><div class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">目標入力完了<br><div class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">自己申告入力中<br><div class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">上長評価入力中<br><div class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">評価完了<br><div class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">最終確定済み<br><div class="mt-1" style="color: #4476C6">1</div></div>
                </div>
            </div>
            <div class="m-2">
                <div class="row">
                ...
                <div class="row text-center w-75">
                    <div class="col-2 border py-3">SS<br><div class="mt-1"  style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">S<br><div  class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">A<br><div  class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">B<br><div  class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">C<br><div  class="mt-1" style="color: #4476C6">1</div></div>
                    <div class="col-2 border py-3">未設定<br><div class="mt-1" style="color: #4476C6">1</div></div>
                </div>
            </div>
        </div>
    </div>
            ...
            @foreach($columns as $column)
                <li class="table-row">
                    ...
                    @elseif($column->progress == 6)
                        <div class="col col-1.5">
                            <button class="btn btn-none p-0" type="button" >
                                <a href="{{ action('EvaluationController@eva_boss2', $column->id)}}" class="">
                    ...
                    @else
                        <div class="col col-1.5">
                            <button class="btn btn-none p-0" type="button" >
                                <a href="{{ action('EvaluationController@check_for_boss2', $column->id)}}" class="">
                                    <i class="fas fa-scroll fa-1x"></i>
                                </a>
                            </button>
                        </div>
                    ...
                    @else
                        <div class="col col-1.5">{{$column->evaluation}}</div>
                    @endif
                    @if($column->progress == null || $column->progress < 2)
                        <div class="col col-1.5">
                        </div>
