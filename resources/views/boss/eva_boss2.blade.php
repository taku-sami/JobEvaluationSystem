                                ...
                                <table>
                                    ...
                                    @foreach($items as $item)
                                        ...
                                        <tr class="row100 body border-bottom" style="height: 80px;">
                                            <td class="cell100 employee_column2 text-center">２次評価者</td>
                                            <td class="cell100 employee_column2 text-center">
                                                <label class="px-2"><input name="boss2_eva[{{$n}}]" required type="radio" value="5">SS</label>
                                                <label class="px-2"><input name="boss2_eva[{{$n}}]" required type="radio" value="4">S</label>
                                                <label class="px-2"><input name="boss2_eva[{{$n}}]" required type="radio" value="3">A</label>
                                                <label class="px-2"><input name="boss2_eva[{{$n}}]" required type="radio" value="2">B</label>
                                                <label class="px-2"><input name="boss2_eva[{{$n}}]" required type="radio" value="1">C</label>
                                            </td>
                                            <td rowspan="" class="cell100 employee_column2" style="color: lightgray">
                                                @if ($errors->has("boss2_comment.$n"))
                                                    <div class="alert alert-danger">{{$errors->first("boss2_comment.$n")}}</div>
                                                @endif
